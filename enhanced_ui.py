...
class ProfileManager:
    ...
    def create_profile_wizard():
        ...
        with st.form("profile_form"):
            ...
            with col2:
                home_country = st.selectbox("Home Country*", [
                    "United States", "United Kingdom", "Canada", "Australia", 
                    "Germany", "France", "Other"
                ])
                passport_country = st.selectbox("Passport Country*", [
                    "United States", "United Kingdom", "Canada", "Australia",
                    "Germany", "France", "Other"
                ])
    ...
    def create_exit_fund_wizard(user_id: str):
        ...
        with st.form("exit_fund_form"):
            ...
            with col1:
                amount = st.number_input("Amount*", min_value=1000, max_value=50000, value=5000, step=500)
            ...
            if crypto:
                ...
                wallet = st.text_input("Wallet Address", placeholder="0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb")
            if wire:
            ...
            submitted = st.form_submit_button("Create Exit Fund", use_container_width=True)
...
class TripPlanner:
    ...
    def assess_destination_risk(destination: Location) -> dict:
        ...
        risk_database = {
            # High Risk
            "ukraine": {"political": 2, "natural": 7, "healthcare": 5, "payment": 4, "overall": 9},
            "afghanistan": {"political": 1, "natural": 6, "healthcare": 3, "payment": 3, "overall": 10},
            "syria": {"political": 1, "natural": 6, "healthcare": 3, "payment": 2, "overall": 9},
            "turkey": {"political": 4, "natural": 6, "healthcare": 7, "payment": 6, "overall": 7},
            "lebanon": {"political": 3, "natural": 6, "healthcare": 6, "payment": 3, "overall": 8},
            
            # Moderate Risk
            "egypt": {"political": 5, "natural": 7, "healthcare": 6, "payment": 6, "overall": 6},
            "pakistan": {"political": 4, "natural": 5, "healthcare": 5, "payment": 5, "overall": 7},
            "russia": {"political": 5, "natural": 7, "healthcare": 7, "payment": 6, "overall": 6},
            "iran": {"political": 3, "natural": 6, "healthcare": 6, "payment": 4, "overall": 8},
            "india": {"political": 7, "natural": 6, "healthcare": 6, "payment": 7, "overall": 4},
            "china": {"political": 6, "natural": 6, "healthcare": 7, "payment": 8, "overall": 5},
            "brazil": {"political": 6, "natural": 7, "healthcare": 6, "payment": 7, "overall": 4},
            "mexico": {"political": 5, "natural": 7, "healthcare": 6, "payment": 7, "overall": 5},
            
            # Low Risk
            "united states": {"political": 9, "natural": 7, "healthcare": 9, "payment": 10, "overall": 2},
            "usa": {"political": 9, "natural": 7, "healthcare": 9, "payment": 10, "overall": 2},
            "united kingdom": {"political": 9, "natural": 9, "healthcare": 9, "payment": 10, "overall": 2},
            "uk": {"political": 9, "natural": 9, "healthcare": 9, "payment": 10, "overall": 2},
            "canada": {"political": 9, "natural": 8, "healthcare": 9, "payment": 10, "overall": 2},
            "germany": {"political": 9, "natural": 9, "healthcare": 9, "payment": 10, "overall": 2},
            "france": {"political": 8, "natural": 8, "healthcare": 9, "payment": 10, "overall": 3},
            "australia": {"political": 9, "natural": 7, "healthcare": 9, "payment": 10, "overall": 2},
            "japan": {"political": 9, "natural": 5, "healthcare": 9, "payment": 10, "overall": 3},
            "singapore": {"political": 9, "natural": 8, "healthcare": 9, "payment": 10, "overall": 2},
            "switzerland": {"political": 10, "natural": 9, "healthcare": 10, "payment": 10, "overall": 1},
            "norway": {"political": 10, "natural": 9, "healthcare": 10, "payment": 10, "overall": 1},
            "greece": {"political": 7, "natural": 7, "healthcare": 7, "payment": 8, "overall": 3},
        }
    ...
    def show_trip_planner():
        ...
        with col1:
            destination_city = st.text_input("Destination City", placeholder="e.g., Mumbai, Tokyo, London")
            destination_country = st.text_input("Destination Country", placeholder="e.g., India, Japan, UK")
        ...
        with col2:
            trip_purpose = st.selectbox("Trip Purpose", [
                "Tourism", "Business", "Study", "Work", "Family Visit"
            ])
            
            budget = st.number_input("Budget (USD)", min_value=1000, value=5000, step=500)
        ...
        if st.button("📊 Assess Risk", use_container_width=True):
            if destination_city and destination_country:
                ...
                with col2:
                    st.metric("Political Stability", f"{risk['political_stability']}/10")
                with col3:
                ...
                if risk['overall_risk'] >= 7:
                    st.error(f"🔴 **HIGH RISK** - {destination_city}, {destination_country}")
                    ...
                    st.warning(f"🟡 **MODERATE RISK** - {destination_city}, {destination_country}")
                    st.write("**Recommendations:**")
                    st.write("- ✅ Exit fund recommended")
                    st.write("- ✅ Monitor local news and alerts")
                    st.write("- ✅ Keep emergency contacts updated")
                else:
                    st.success(f"🟢 **LOW RISK** - {destination_city}, {destination_country}")
                    st.write("**Recommendations:**")
...
class NotificationCenter:
    ...
    def show_notification_settings():
        ...
        st.info(f"You will receive alerts when risk level reaches {risk_threshold}/10 or higher")
...
class AnalyticsDashboard:
    ...
    def show_analytics():
        ...
        st.line_chart({
            "Risk Level": [2, 3, 2, 4, 3, 2, 3]
        })
        
        st.markdown("### 🌍 Alert History")
        
        alerts_data = [
            {"Date": "2025-12-10", "Location": "Istanbul", "Type": "Political", "Severity": 6},
            {"Date": "2025-12-05", "Location": "Beirut", "Type": "Payment", "Severity": 7},
            {"Date": "2025-12-01", "Location": "Tokyo", "Type": "Natural", "Severity": 5}
        ]
